    ...
    <div>
      <div className="bg-darkBlue h-screen flex justify-center">
        <div className="flex flex-col  w-[90vw] md:w-lg max-w-xl h-[50vh] mb-60 px-14 lg:px-8 my-auto items-center bg-darkGrayishBlue text-lightCyan relative rounded-xl">
          ...
          ></div>
          <button
            className="bg-neonGreen hover:before:visible w-16 h-16 border-none outline-none z-10 rounded-full flex absolute top-[43vh] mt-[2vh]  justify-center items-center cursor-pointer shadow-2xl"
            onClick={fetchAdvice}
